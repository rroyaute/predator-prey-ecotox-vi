...
function eq_sol(d_val, sigma_val)
    ...
    C_sol = (params_spec.r * R_sol * (1 - R_sol / params_spec.k)) /
           (R_sol * int_1(R_sol,
...
function det_tr(d_val, sigma_val, sol)
    ...
    j11 = params_spec.r * (1 - (2 * R_sol) / params_spec.k) -
        C_sol * int_2(R_sol, params_spec.a, params_spec.alpha, params_spec.tau,
                      params_spec.h, params_spec.eta_min, params_spec.eta_max, params_spec.nu,
                      params_spec.X, params_spec.sigma)
    j12 = -R_sol * int_1(R_sol, params_spec.a, params_spec.alpha, params_spec.tau,
                         params_spec.h, params_spec.eta_min, params_spec.eta_max, params_spec.nu,
                         params_spec.X, params_spec.sigma)
    j21 = params_spec.epsilon * C_sol * int_2(R_sol, params_spec.a, params_spec.alpha, params_spec.tau,
                                              params_spec.h, params_spec.eta_min, params_spec.eta_max, params_spec.nu,
                                              params_spec.X, params_spec.sigma)
    j22 = params_spec.epsilon * R_sol * int_1(R_sol, params_spec.a, params_spec.alpha, params_spec.tau,
                                              params_spec.h, params_spec.eta_min, params_spec.eta_max, params_spec.nu,
                                              params_spec.X, params_spec.sigma) - params_spec.beta
    jacobian_at_eq = [
        j11  j12;
        j21  j22
    ]
